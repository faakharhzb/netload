...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="netload",
        description="A fast and easy to use HTTP file downloader.",
    )
...
def show_progress(size: int | str, downloaded: int, wheel: Iterator) -> None:
    if type(size) is int:
...
def save_file(
    ...
    with open(filename, "wb") as f:
        while True:
            ...
            show_progress(size, downloaded, wheel)
